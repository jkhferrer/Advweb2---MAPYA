...
<div class="banner">
	<div class="callbacks_container">
	  ...
	  <div class="header">
				<div class="logo">
					<a href="index.html"><img src="assests/images/lite.png" class="img-responsive" alt="" /></a>
				</div>
				<div class="head-nav">
...
<!-- welcome -->
	<div class="welcome">
			<div class="col-md-6 welcome-left">
					<img src="assests/images/right.jpg" class="img-responsive" alt="" />
				<div class="welcome-lefttop">	
						...
						<div class="button">
							<a href="about.html" class="btn  btn-1c btn1 btn-1d">LEARN MORE</a>	
						</div>
				</div>
			</div>
	...
	<div class="vero">
			<div class="container">
					<section class="slider">
						...
						<!-- FlexSlider -->
							  <script defer src="assests/js/jquery.flexslider.js"></script>
